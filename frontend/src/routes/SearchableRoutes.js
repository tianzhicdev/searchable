...
import OfflinePublishSearchable from '../views/searchables/OfflinePublishSearchable';
        ...
        <Route path={['/searchables', '/searchable-item/:id', '/offline-item/:id', '/profile/:identifier', '/publish-searchables', '/publish-offline-searchables', '/profile', '/my-purchases']}>
            <Switch location={location} key={location.pathname}>
                ...
                <AuthGuard>
                    ...
                    <Route exact path="/publish-offline-searchables" component={OfflinePublishSearchable} />
