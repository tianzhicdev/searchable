...
import { ArrowBack, Visibility, VisibilityOff, MonetizationOn } from '@material-ui/icons';
...
const Onboarding5_1 = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Step 3: Create the direct payment searchable
      ...
      <Container maxWidth="md">
        <Paper className={classes.paper} elevation={3}>
          ...
          <Typography variant="h6" color="textSecondary" gutterBottom>
            Final step! Set up your account for "{donationData.title}"
          </Typography>
